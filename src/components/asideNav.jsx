          ...
          <header>
            ...
            <nav>
              <div className="new-chat-logo">
                <div>
                  <img src="https://framerusercontent.com/images/iZ4EXrlvpPlxiLFsOrcqwzPbOc.svg" alt="" />
                </div>
                <p>New Chat</p>
              </div>
            ...
            <div className="bottom-info">
                <div className="Upgrade-plan">
                    <a href='https://developers.hypermode.com/workers-ai/models/llama-2-7b-chat-fp16/' target="_black" className="">
                        <div className="">
                            {/* <!-- SVG --> */}
                        ...
                        <div className="">
                            ...
                            <p className="">Workers AI, Llama, and more </p>
                        </div>
                      </a>
                </div>
